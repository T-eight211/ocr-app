...
import { X, RotateCcw, Check } from "lucide-react"; // Retake and Confirm icons
...
export const ScanOverlay: React.FC<ScanOverlayProps> = ({ onClose, onCapture }) => {
  ...
  const handleCapture = async () => {
    ...
    // Convert to data URL to preview
  ...
  return (
    <div className="fixed inset-0 backdrop-blur p-8 flex flex-col">
      ...
      <div className="grid grid-rows-[1fr_7fr_2fr] flex-1 max-w-lg mx-auto gap-2">
        {/* Instructions */}
